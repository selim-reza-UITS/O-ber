...
rider_pattern = [
    ...
    path("accounts/profile/update/",accounts_profile.UserProfileUpdateView.as_view(),name="profile_update"),
    ...
    path("ride/<int:ride_id>/messages/", riders.RideChatHistoryView.as_view(), name="ride_chat_history"),
